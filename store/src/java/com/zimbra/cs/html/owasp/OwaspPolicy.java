...
public class OwaspPolicy {
    ...
    static final String E_OWASP_POLICY = "owasp_policy";
    static final String E_DISALLOW_TEXT_IN = "disallow_text_in";
    static final String E_URL_PROTOCOLS = "url_protocols";
    static final String E_HTML = "html";
    static final String A_ELEMENT = "element";
    static final String A_REMOVE_TEXT = "removeText";
    static final String E_ATTRIBUTES = "attributes";
    ...
    private String defaultPolicyFile() {
        ...
        return FS + "opt" + FS + "zimbra" + FS + "conf" + FS + "owasp_policy.xml";
    }
