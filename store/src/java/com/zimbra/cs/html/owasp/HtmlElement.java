...
public class HtmlElement {
    ...
    private Map<String, AttributePolicy> attributesAndWhitelist;

    HtmlElement(String element, ElementPolicy elementPolicy,
                Map<String, AttributePolicy> attributesAndWhitelist) {
    ...
    public void configure(HtmlPolicyBuilder policyBuilder, boolean neuterImages) {
        ...
        for (String attribute : allowedAttributes) {
            ...
            AttributePolicy attrPolicy = attributesAndWhitelist.get(attribute);
            if (attrPolicy != null) {
